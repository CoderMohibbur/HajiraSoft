            ...
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">List of all available districts</p>
                    </div>
                </div>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-gray-800 dark:text-gray-100">
                    @forelse($districts as $district)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-4 py-2">{{ $district->division }}</td>
                            <td class="px-4 py-2">{{ $district->code }}</td>
                            ...
                            <td class="px-4 py-2 text-center space-x-2">
                                ...
                                <form action="{{ route('districts.destroy', $district) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure to delete this district?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center px-4 py-4 text-gray-500 dark:text-gray-400">No districts found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

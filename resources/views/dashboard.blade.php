...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Total Madrasahs -->
    <div class="relative overflow-hidden bg-white shadow-lg rounded-xl p-5 border-l-8 border-blue-500 hover:shadow-2xl transition-all duration-300">
        ...
        <p class="text-4xl font-extrabold text-blue-600 mt-2">5</p>
        <span class="text-xs text-gray-400 block mt-1">as of today</span>
    </div>

    <!-- Total Teachers -->
    <div class="relative overflow-hidden bg-white shadow-lg rounded-xl p-5 border-l-8 border-green-500 hover:shadow-2xl transition-all duration-300">
    ...
    <!-- Today's Attendance -->
    <div class="relative overflow-hidden bg-white shadow-lg rounded-xl p-5 border-l-8 border-purple-500 hover:shadow-2xl transition-all duration-300">
    ...
    <!-- Absentees -->
    <div class="relative overflow-hidden bg-white shadow-lg rounded-xl p-5 border-l-8 border-red-500 hover:shadow-2xl transition-all duration-300">
...
<div class="bg-gradient-to-br from-white via-blue-50 to-white shadow-2xl rounded-3xl overflow-hidden mb-10 border border-blue-200">
    <div class="px-6 py-6 bg-gradient-to-r from-blue-100 via-white to-blue-50 border-b border-blue-300 flex items-center justify-between">
        <h3 class="text-xl font-extrabold text-blue-900 tracking-wide flex items-center gap-2">
            <svg class="w-7 h-7 text-blue-600 drop-shadow-md animate-pulse" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
        ...
        <table class="min-w-full text-sm text-left divide-y divide-gray-100">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                <tr class="hover:bg-blue-50 transition duration-200 group">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-200 text-green-800 shadow group-hover:scale-105 transition">
                            ✅ Present
                        </span>
                    </td>
                ...
                <tr class="hover:bg-blue-50 transition duration-200 group">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-red-200 text-red-800 shadow group-hover:scale-105 transition">
                            ❌ Absent
                        </span>
                    </td>
    ...
    <div class="space-y-6 text-indigo-900 text-[15px]">
      ...
      <div class="bg-white px-6 py-6 rounded-2xl border-l-4 border-indigo-500 shadow-md hover:shadow-xl transition flex flex-col gap-3">
        <div class="flex items-start justify-between">
          ...
          <div class="text-xs text-gray-500 text-right">🆔 ID: #20250407<br>📅 Expiry: 15-Apr-2025</div>
        </div>
        <button onclick="alert('Previewing guideline.pdf')" class="text-indigo-600 text-sm underline hover:text-indigo-800 flex items-center gap-1">
      ...
      <div class="bg-white px-6 py-6 rounded-2xl border-l-4 border-indigo-400 shadow-md hover:shadow-xl transition flex flex-col gap-3">
        <div class="flex items-start justify-between">
          ...
          <div class="text-xs text-gray-500 text-right">🆔 ID: #20250407-B<br>📅 Expiry: 30-Apr-2025</div>
        </div>
        <button onclick="alert('Previewing weekly-off-notice.docx')" class="text-indigo-600 text-sm underline hover:text-indigo-800 flex items-center gap-1">
      ...
      <div class="bg-white px-6 py-6 rounded-2xl border-l-4 border-indigo-300 shadow-md hover:shadow-xl transition flex flex-col gap-3">
        <div class="flex items-start justify-between">
          ...
          <div class="text-xs text-gray-500 text-right">🆔 ID: #20250403<br>📅 Expiry: 20-Apr-2025</div>
        </div>
        <button onclick="alert('Previewing audit-instructions.pdf')" class="text-indigo-600 text-sm underline hover:text-indigo-800 flex items-center gap-1">
